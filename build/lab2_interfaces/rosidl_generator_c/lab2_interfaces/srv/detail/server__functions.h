...
#ifndef LAB2_INTERFACES__SRV__DETAIL__SERVER__FUNCTIONS_H_
#define LAB2_INTERFACES__SRV__DETAIL__SERVER__FUNCTIONS_H_
...
#include "lab2_interfaces/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_lab2_interfaces
bool
 ...
 * calls
 * lab2_interfaces__srv__Server_Request__init().
...
/**
 * It calls
 * lab2_interfaces__srv__Server_Request__fini()
 ...
 * lab2_interfaces__srv__Server_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * lab2_interfaces__srv__Server_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lab2_interfaces__srv__Server_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lab2_interfaces
...
/**
 * It calls
 * lab2_interfaces__srv__Server_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_lab2_interfaces
...
/**
 * It allocates the memory for the array and calls
 * lab2_interfaces__srv__Server_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lab2_interfaces
...
/**
 * It calls
 * lab2_interfaces__srv__Server_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LAB2_INTERFACES__SRV__DETAIL__SERVER__FUNCTIONS_H_
