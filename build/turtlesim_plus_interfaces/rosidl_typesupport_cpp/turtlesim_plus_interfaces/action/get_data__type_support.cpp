...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlesim_plus_interfaces, action, GetData_SendGoal)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<turtlesim_plus_interfaces::action::GetData_SendGoal>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlesim_plus_interfaces, action, GetData_GetResult)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<turtlesim_plus_interfaces::action::GetData_GetResult>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_action_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__ACTION_SYMBOL_NAME(rosidl_typesupport_cpp, turtlesim_plus_interfaces, action, GetData)() {
  return ::rosidl_typesupport_cpp::get_action_type_support_handle<turtlesim_plus_interfaces::action::GetData>();
}
